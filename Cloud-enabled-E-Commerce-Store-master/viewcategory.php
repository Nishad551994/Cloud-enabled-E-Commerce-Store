<?php
	...
	if($opr=="del")
	{
		$del_sql=mysqli_query($con, "DELETE FROM category WHERE catid='$catid1'");
		if($del_sql)
				 ...
				 <div class="row">
					...
					<div class="col-md-12">
						<form method="post">
							...
							<tr align="center" >
								<td colspan="9" style="font-size:24px; color:#006;" >View Category</td>
							</tr>
							<tr align="center">
								<td  colspan="9">
							...
							if($key !="")
								$sql_sel=mysqli_query($con, "SElECT * FROM category WHERE catname like '$key%'");
							else
								$sql_sel=mysqli_query($con, "SELECT * FROM category");		
							...
							?>
								...
								<td align="center">
									<a href="viewcategory.php?aid=<?php echo $aid;?>&opr=del&catid=<?php echo $row['catid'];?>" title="Delete"><img src="picture/delete.png" /></a>
								</td>
								<td  align="center">
									<a href="insertcategory.php?aid=<?php echo $aid;?>&opr=edit&catid=<?php echo $row['catid'];?>" title="Update"><img src="picture/update.png" /></a>
								</td>									 
							</tr>							   
							<?php	
								}//end of while
