...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <div>
                    <a href="showproduct.php?cid=<?php echo $cid1?>&catid=CAT1" class="list-group-item active">Electronics
                    </a>
                    <ul class="list-group">
                ...
                <!-- /.div -->
                <div>
                    <a href="showproduct.php?cid=<?php echo $cid1?>&catid=CAT2" class="list-group-item active list-group-item-success">Clothing & Wears
                    </a>
                    <ul class="list-group">
                ...
                <!-- /.div -->
                <div>
                    <a href="showproduct.php?cid=<?php echo $cid1?>&catid=CAT3" class="list-group-item active">Accessaries & Extras
                    </a>
                    <ul class="list-group">
            ...
            <div class="col-md-9">
                <div>
                    <ol class="breadcrumb">                       
                        <li><h2>Products Selection</h2></li>
                    </ol>
                </div>
                <!-- /.div -->
                <div class="row">
				...
				<div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            ...
                            <div class="caption">
                                ...
                                <p><a href="addcart.php?cid=<?php echo $cid1;?>&pid=<?php echo $row['pid'];?>&src=2" class="btn btn-success" role="button">Add To Cart</a> 
            ...
            <!-- /.col -->
			 <div class="row">
                    <ul class="pagination alg-right-pad">
                        ...
                        <li><a href="showproduct.php?cid=<?php echo $cid1?>&catid=<?php echo $catid;?>&pgno=1">1</a></li>
                        <li><a href="showproduct.php?cid=<?php echo $cid1?>&catid=<?php echo $catid;?>&pgno=2">2</a></li>
                        <li><a href="showproduct.php?cid=<?php echo $cid1?>&catid=<?php echo $catid;?>&pgno=3">3</a></li>
                        <li><a href="showproduct.php?cid=<?php echo $cid1?>&catid=<?php echo $catid;?>&pgno=4">4</a></li>
                        <li><a href="showproduct.php?cid=<?php echo $cid1?>&catid=<?php echo $catid;?>&pgno=5">5</a></li>
