<?php
	...
	if($opr=="del")
	{
		$del_sql=mysqli_query($con, "DELETE FROM customer WHERE cid='$cid1'");
		if($del_sql)
...
<form method="post">
	...
	<tr align="center" >
    		<td colspan="6" style="font-size:24px; color:#006;" >View Customer</td>
	</tr>
	<tr>
         <td colspan="6" align="center">
        	<input type="text" name="searchtxt" title="Enter name for search " class="search" autocomplete="off"/>
        	&nbsp;		
        	<button class="grey" type="submit" name="btnsearch" value="Search" id="button-search" title="Search Customer" />Search </button>      
		</td> 
    </tr>
		<tr>  
	...
	if($key !="")
		$sql_sel=mysqli_query($con, "SElECT * FROM customer WHERE cname like '$key%'or address like'$key%' or email like '$key%' ");	
	else
    ...
    ?>
    	<tr bgcolor="<?php echo $color?>">
            ...
            <td align="center"><a href="viewcustomer.php?opr=del&cid=<?php echo $row['cid'];?>" title="Delete"><img src="picture/delete.png" /></a></td>
