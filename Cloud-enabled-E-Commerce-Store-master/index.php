        ...
        <div class="row">
            <div class="col-md-9">
                <div class="well well-lg offer-box text-center">
                   Today's Offer : &nbsp; <span class="glyphicon glyphicon-cog"></span>&nbsp;40 % off  on purchase of $ 2,000 and above till 15 july!                
                </div>
				...
				<div class=" col-md-12 col-sm-6 col-xs-6">
                    ...
                    <div class="thumbnail product-box">
                        ...
                        <div class="caption">                       
							...
							Certified Refurshed products<br>
							Different brands awesome products<br>
							High quality products at great prices<br>
                ...
                <div class="row">
                    <div class="btn-group alg-right-pad">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="index.php?cid=<?php echo $cid1;?>&opt=price&val=asc">By Price Low</a></li>
                                <li class="divider"></li>
                                <li><a href="index.php?cid=<?php echo $cid1;?>&opt=price&val=desc">By Price High</a></li>                             
                            </ul>
                        </div>
                    </div>
                </div>
               <!-- /.row -->
				...
				<?php
					...
					{						
						...
						{
							case 1:
								$sqlstmt="SELECT * FROM products order by pprice $val LIMIT 6 offset 6";
								break;
							case 2:
								$sqlstmt="SELECT * FROM products order by pprice $val LIMIT 6 offset 12";
								break;
							case 3:
								$sqlstmt="SELECT * FROM products order by pprice $val LIMIT 6 offset 18";
								break;
							case 4:
								$sqlstmt="SELECT * FROM products order by pprice $val LIMIT 6 offset 24";
								break;
							case 5:
								$sqlstmt="SELECT * FROM products order by pprice $val LIMIT 6 offset 30";
								break;
							default:
								$sqlstmt="SELECT * FROM products order by pprice $val LIMIT 6";
						}
						//echo $sqlstmt;						
					}
					else //normal view
				...
				<?php
					...
					else if($opt=="price")// normal view
					{
				?>				
				<div class="row">
                    <ul class="pagination alg-right-pad">
                        <li><a href="#">&laquo;</a></li>
                        <li><a href="index.php?cid=<?php echo $cid1;?>&opt=price&val=<?php if($val=='asc'){echo 'asc';}else{echo 'desc';}?>&pgno=1">1</a></li>
                        <li><a href="index.php?cid=<?php echo $cid1;?>&opt=price&val=<?php if($val=='asc'){echo 'asc';}else{echo 'desc';}?>&pgno=2">2</a></li>
                        <li><a href="index.php?cid=<?php echo $cid1;?>&opt=price&val=<?php if($val=='asc'){echo 'asc';}else{echo 'desc';}?>&pgno=3">3</a></li>
                        <li><a href="index.php?cid=<?php echo $cid1;?>&opt=price&val=<?php if($val=='asc'){echo 'asc';}else{echo 'desc';}?>&pgno=4">4</a></li>
                        <li><a href="index.php?cid=<?php echo $cid1;?>&opt=price&val=<?php if($val=='asc'){echo 'asc';}else{echo 'desc';}?>&pgno=5">5</a></li>
                        <li><a href="#">&raquo;</a></li>
                    </ul>
                </div>
				<?php
