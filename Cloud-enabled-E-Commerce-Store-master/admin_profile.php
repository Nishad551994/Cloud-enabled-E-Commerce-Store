			...
			<div class="col-md-12">
				<?php
					...
					if($count>0)
					{
						...
						echo "<tr><td align='center'><font size='5'>Active Customers Monitor</font></td></tr>";
						echo "<tr><td><span style='color:blue;font-size:16px;font-weight:bold;float:left'>Total Active Customers: $count</span>&nbsp;<span style='color:blue;font-size:16px;font-weight:bold;float:right'>Date: $today</span></td></tr>";
						...
						while($rowlvl=mysqli_fetch_array($sql_lvl))
						{
							...
							echo "<table border='1' align='left' cellpadding='0' cellspacing='0'>";
							echo "<tr><td width='10' title='",$title3,"' bgcolor=",$color3,">&nbsp;</td></tr>
							<tr><td width='10' title='",$title2,"' bgcolor=",$color2,">&nbsp;</td></tr>
							<tr><td width='10' title='",$title1,"' bgcolor=",$color1,">&nbsp;</td></tr>
							<tr><td width='10' bgcolor='#18b424'><span style='color:#FFF;'>",$rowlvl[1],"</span></td></tr>";
							echo "</table>";
						}
						echo "</td></tr>";
						echo "</table>";
